...
mixin _$ContentsStore on ContentsStoreBase, Store {
  ...
  late final _$failureAtom =
      Atom(name: 'ContentsStoreBase.failure', context: context);
  ...
  late final _$ContentsStoreBaseActionController =
      ActionController(name: 'ContentsStoreBase', context: context);

  @override
  dynamic clearFailure() {
    final _$actionInfo = _$ContentsStoreBaseActionController.startAction(
        name: 'ContentsStoreBase.clearFailure');
    try {
      return super.clearFailure();
    } finally {
      _$ContentsStoreBaseActionController.endAction(_$actionInfo);
    }
  }
